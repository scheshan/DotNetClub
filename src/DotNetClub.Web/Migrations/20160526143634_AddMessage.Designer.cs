...
namespace DotNetClub.Web.Migrations
{
    ...
    [Migration("20160526143634_AddMessage")]
    partial class AddMessage
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("DotNetClub.Core.Entity.Message", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd();
                    ...
                    b.HasAnnotation("SqlServer:TableName", "Message");
                });
            ...
            modelBuilder.Entity("DotNetClub.Core.Entity.Message", b =>
                {
                    b.HasOne("DotNetClub.Core.Entity.Comment")
                        .WithMany()
